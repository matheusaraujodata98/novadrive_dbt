...
def postgres_to_snowflake_etl():
    ...
    for table_name in table_names:
        max_id_task = get_max_primary_key.override(task_id=f'get_max_id_{table_name}')(table_name)
        load_task = load_incremental_data.override(task_id=f'load_data_{table_name}')(table_name, max_id_task)
        max_id_task >> load_task

postgres_to_snowflake_dag = postgres_to_snowflake_etl()